              ...
              <div className="px-6">
                ...
                <div className="text-center mt-12">
                  ...
                  <div className="mb-2 text-blueGray-600 mt-10">
                    ...
                    Semi-Professtional Pong Player - 42 Club
                  </div>
                  ...
                  <div className="flex flex-wrap justify-center">
                    <div className="w-full lg:w-9/12 px-4">
                      <p className="mb-4 text-lg leading-relaxed text-blueGray-700">
                        Passionate online pong player with lightning-fast
                        reflexes and a strategic mind. Consistently aiming for
                        the perfect bounce and paddle precision. Join me in the
                        virtual arena for intense matches and friendly
                        competition!
                      </p>
